...
"""
exhaustive_adni2.py
Exhaustive re-evaluation of every misclassified AD query on the ADNI2
cohort, replicating the same protocol as exhaustive_adni1.py (Sec. 4,
...
Unlike relevance_feedback_adni2.py, which evaluates a fixed 25-query
...
OUT_RF           = 'adni2_validation/features/exhaustive_misclassified_results_adni2.csv'
