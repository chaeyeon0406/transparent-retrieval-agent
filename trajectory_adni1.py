...
"""
trajectory_adni1.py
Feedback-round convergence analysis (Sec. 3, "Sample-efficient convergence",
...
evaluated in relevance_feedback_adni1.py.
...
OUT_RF           = 'features/trajectory_results_adni1.csv'
