#!/usr/bin/env python3
"""
relevance_feedback_adni1.py
Relevance feedback evaluation replicating Agarwal & Mostafa (2011), Sec. 2-3 of the paper.
...
OUT_RF           = 'features/relevance_feedback_results.csv'
