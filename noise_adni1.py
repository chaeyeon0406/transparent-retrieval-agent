...
"""
noise_adni1.py
Noise-robustness analysis (Sec. 3, "Noise robustness", Figure 1b of the
paper).

Uses the full inter- then intra-session feedback pipeline (same as
relevance_feedback_adni1.py), but injects label-flip noise into the
...
OUT_RF           = 'features/noise_results_adni1.csv'
